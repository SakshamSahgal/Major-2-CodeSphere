...
const { ValidateSolutionCode, ValidateRandomTestCaseCode, createQuestionRoute, updateQuestionRoute, FetchFullQuestionDetailsRoute, checkIfQuestionExists, CheckIfAddedInAnyAssignment, deleteQuestionRoute } = require("./Professor/Question.js");
...
app.put("/professors/updateQuestion", ValidateToken, isProfessor, updateQuestionRoute);                        //Updates a Question
